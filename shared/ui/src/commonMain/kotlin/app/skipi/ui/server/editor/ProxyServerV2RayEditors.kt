...
fun LazyListScope.vmessProxyServer(vmessEdit: VMess) {
    item(key = "properties") {
        ...
        TextField(
            label = stringResource(Res.string.proxy_editor_user_id),
        ...
        AppOverlayDropdownPreference(
            title = stringResource(Res.string.proxy_editor_encryption),
...
fun LazyListScope.trojanProxyServer(trojanEdit: Trojan) {
    item(key = "properties") {
        val focusManager = LocalFocusManager.current
        SmallTitle(text = stringResource(Res.string.proxy_editor_properties))
        TextField(
...
fun LazyListScope.vlessProxyServer(vlessEdit: VLESS) {
    item(key = "properties") {
        val focusManager = LocalFocusManager.current
        ...
        TextField(
            label = stringResource(Res.string.proxy_editor_encryption),
        ...
        AppOverlayDropdownPreference(
            title = stringResource(Res.string.proxy_editor_flow),
            items = flowOptions,
            modifier = Modifier.padding(bottom = 12.dp),
