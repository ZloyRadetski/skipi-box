...
package app.skipi.ui.server.validation
...
fun rememberProxyServerValidationMessageResolver(): (ProxyServerValidationIssue) -> String {
    val messages = ProxyServerValidationMessages(
        ...
        awgJminMaxInvalid = stringResource(Res.string.proxy_validation_awg_jmin_max_invalid),
        olcRtcKeyInvalid = stringResource(Res.string.proxy_validation_olcrtc_key_invalid),
    )
