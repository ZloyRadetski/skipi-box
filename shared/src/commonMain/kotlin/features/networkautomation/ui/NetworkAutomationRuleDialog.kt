...
import app.shared.res.network_automation_action_disconnect
import app.shared.res.network_automation_action_switch_if_connected
import app.shared.res.network_automation_action_switch_server
import app.shared.res.network_automation_add_rule
import app.shared.res.network_automation_edit_rule
import app.shared.res.network_automation_rule_action
import app.shared.res.network_automation_rule_type
import app.shared.res.network_automation_save
import app.shared.res.network_automation_server_label
import app.shared.res.network_automation_ssid_exists_error
import app.shared.res.network_automation_ssid_label
import app.shared.res.network_automation_type_any_wifi
import app.shared.res.network_automation_type_cellular
import app.shared.res.network_automation_type_exists_error
import app.shared.res.network_automation_type_specific_wifi
import app.shared.res.network_automation_use_current_wifi
...
@Composable
fun NetworkAutomationRuleDialog(
    show: Boolean,
    ...
    val typeOptions = listOf(
        stringResource(Res.string.network_automation_type_cellular),
        stringResource(Res.string.network_automation_type_any_wifi),
        stringResource(Res.string.network_automation_type_specific_wifi),
    )
    ...
    val actionOptions = listOf(
        stringResource(Res.string.network_automation_action_switch_server),
        stringResource(Res.string.network_automation_action_switch_if_connected),
        stringResource(Res.string.network_automation_action_disconnect),
    )
    ...
    WindowDialog(
        show = true,
        title = if (isEditing) stringResource(Res.string.network_automation_edit_rule) else stringResource(Res.string.network_automation_add_rule),
        ...
        Column(
            ...
            Card(
                ...
                WindowDropdownPreference(
                    title = stringResource(Res.string.network_automation_rule_type),
                    items = typeOptions,
            ...
            AnimatedVisibility(
                ...
                Column(
                    ...
                    TextField(
                        ...
                        label = stringResource(Res.string.network_automation_ssid_label),
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(bottom = 8.dp),
                    )
                    ...
                    Row(
                        ...
                        TextButton(
                            text = stringResource(Res.string.network_automation_use_current_wifi),
                            onClick = {
                    ...
                    if (isSsidDuplicate) {
                        Text(
                            text = stringResource(Res.string.network_automation_ssid_exists_error),
            ...
            if (isTypeDuplicate) {
                Text(
                    text = stringResource(Res.string.network_automation_type_exists_error),
                    color = Color(0xFFE53935),
                    style = MiuixTheme.textStyles.body2,
            ...
            Card(
                ...
                WindowDropdownPreference(
                    title = stringResource(Res.string.network_automation_rule_action),
                    items = actionOptions,
                ...
                if (requiresServer && servers.isNotEmpty()) {
                    WindowDropdownPreference(
                        title = stringResource(Res.string.network_automation_server_label),
                        items = serverOptions,
            ...
            Row(
                ...
                TextButton(
                    text = stringResource(Res.string.network_automation_save),
                    enabled = canSave,
                    onClick = {
