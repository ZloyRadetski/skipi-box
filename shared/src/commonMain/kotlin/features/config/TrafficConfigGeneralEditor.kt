...
import app.shared.res.configs_dns_servers
import app.shared.res.configs_general_title
import app.shared.res.configs_ipv6
import app.shared.res.configs_ipv6_prefer
...
@Composable
fun TrafficConfigGeneralEditor(
    show: Boolean,
    rawConfig: String,
    ...
    WindowDialog(
        show = true,
        title = stringResource(Res.string.configs_general_title),
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            TextField(
                ...
                label = stringResource(Res.string.configs_dns_servers),
