...
import app.shared.res.configs_android_core
import app.shared.res.configs_android_title
import app.shared.res.configs_android_vpn
import app.shared.res.configs_append_http_proxy
import app.shared.res.configs_fake_dns
import app.shared.res.configs_fragment
import app.shared.res.configs_fragment_interval
import app.shared.res.configs_fragment_length
import app.shared.res.configs_fragment_packets
import app.shared.res.configs_hevtun
import app.shared.res.configs_local_dns
import app.shared.res.configs_mux
import app.shared.res.configs_mux_concurrency
import app.shared.res.configs_sniffing
import app.shared.res.configs_sniffing_route_only
import app.shared.res.configs_sniffing_summary
import app.shared.res.configs_tun_dns
import app.shared.res.configs_tun_ipv4
import app.shared.res.configs_tun_ipv6
import app.shared.res.configs_tun_mtu
...
@Composable
fun TrafficConfigAndroidSettingsEditor(
    show: Boolean,
    ...
    WindowBottomSheet(
        show = true,
        title = stringResource(Res.string.configs_android_title),
        startAction = {
        ...
        LazyColumn(
            ...
            item {
                ConfigSettingsSection(
                    title = stringResource(Res.string.configs_android_core),
                ) {
                    SwitchPreference(
                        title = stringResource(Res.string.configs_sniffing),
                        summary = stringResource(Res.string.configs_sniffing_summary),
                        checked = settings.enableSniffing,
                        onCheckedChange = { settings = settings.copy(enableSniffing = it) },
                    )
                    SwitchPreference(
                        title = stringResource(Res.string.configs_sniffing_route_only),
                    ...
                    SwitchPreference(
                        title = stringResource(Res.string.configs_mux),
                    ...
                    if (settings.enableMux) {
                        ConfigTextField(
                            ...
                            label = stringResource(Res.string.configs_mux_concurrency),
                        )
                    }
                    SwitchPreference(
                        title = stringResource(Res.string.configs_fragment),
                    ...
                    if (settings.enableFragment) {
                        ConfigTextField(
                            ...
                            label = stringResource(Res.string.configs_fragment_packets),
                        )
                        ConfigTextField(
                            value = fragmentLength,
                            onValueChange = { fragmentLength = it },
                            label = stringResource(Res.string.configs_fragment_length),
                        )
                        ConfigTextField(
                            value = fragmentInterval,
                            onValueChange = { fragmentInterval = it },
                            label = stringResource(Res.string.configs_fragment_interval),
                        )
                    }
                }
                ConfigSettingsSection(
                    title = stringResource(Res.string.configs_android_vpn),
                ) {
                    SwitchPreference(
                    ...
                    SwitchPreference(
                        title = stringResource(Res.string.configs_fake_dns),
                    ...
                    ConfigTextField(value = mtu, onValueChange = { mtu = it }, label = stringResource(Res.string.configs_tun_mtu))
                    ConfigTextField(value = vpnDns, onValueChange = { vpnDns = it }, label = stringResource(Res.string.configs_tun_dns))
                    ConfigTextField(value = ipv4Cidr, onValueChange = { ipv4Cidr = it }, label = stringResource(Res.string.configs_tun_ipv4))
                    ConfigTextField(value = ipv6Cidr, onValueChange = { ipv6Cidr = it }, label = stringResource(Res.string.configs_tun_ipv6))
                }
            }
        }
    }
