...
data class ProxyAppListClipboardData(
    val mode: Int?,
    val selectedApps: List<String>,
)

data class ProxyAppListClipboardApplyResult(
    val mode: Int,
    val selectedApps: List<String>,
)

fun encodeProxyAppListForClipboard(
...
fun decodeProxyAppListFromClipboard(
    text: String,
    currentUserId: Int,
...
fun applyProxyAppListClipboardImport(
    currentMode: Int,
