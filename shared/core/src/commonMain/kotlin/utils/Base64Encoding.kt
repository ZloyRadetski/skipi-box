...
fun String.decodeBase64OrNull(): ByteArray? {
    return runCatching {
        Base64.decode(this)
    }.getOrNull()
}

fun String.decodeBase64StringOrNull(): String? {
    return decodeBase64OrNull()?.toString(Charsets.UTF_8)
}

fun ByteArray.encodeUrlSafeBase64NoPadding(): String {
    return Base64.UrlSafe
        .withPadding(Base64.PaddingOption.ABSENT)
        .encode(this)
}

fun ByteArray.encodeUrlSafeBase64OptionalPadding(): String {
    return Base64.UrlSafe
        .withPadding(Base64.PaddingOption.ABSENT_OPTIONAL)
        .encode(this)
}

fun String.decodeUrlSafeBase64OptionalPaddingOrNull(): ByteArray? {
    return runCatching {
        Base64.UrlSafe
            .withPadding(Base64.PaddingOption.ABSENT_OPTIONAL)
            .decode(this)
...
fun String.decodeUrlSafeBase64NoPaddingOrNull(): ByteArray? {
    return runCatching {
        Base64.UrlSafe
            .withPadding(Base64.PaddingOption.ABSENT)
            .decode(this)
...
fun String.decodeFlexibleBase64OrNull(): ByteArray? {
