 ...
 * endpoint or the gRPC StatsService. SkipiCore reads these counters directly
 * from the same process.
 */
internal fun JsonObject.withXrayTrafficStatsConfig(): JsonObject {
...
internal fun JsonObjectBuilder.putXrayTrafficStatsConfig(enabled: Boolean) {
    if (!enabled) return
