...
class BroadcastControlReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_START = "com.radetski.skipi.action.PROXY_START"
        const val ACTION_STOP = "com.radetski.skipi.action.PROXY_STOP"
        const val ACTION_TOGGLE = "com.radetski.skipi.action.PROXY_TOGGLE"
