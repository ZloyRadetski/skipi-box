...
internal enum class TrafficConfigExistingWorkPolicy {
    UPDATE,
}

internal data class TrafficConfigWorkSpec(
    val id: Int,
...
internal interface TrafficConfigScheduleGateway {
...
internal class TrafficConfigScheduler(
