...
internal class AppSettingsPreferences(
    ...
    private fun SharedPreferences.Editor.putAppState(state: AppState): SharedPreferences.Editor {
        return putInt(KeyAppIcon, state.appIcon)
            ...
            .apply {
                state.customMaterialYouSeed?.let { putLong(KeyCustomMaterialYouSeed, it) } ?: remove(KeyCustomMaterialYouSeed)
                putBoolean(KeyEnableCustomColors, state.enableCustomColors)
                state.customAccentColor?.let { putLong(KeyCustomAccentColor, it) } ?: remove(KeyCustomAccentColor)
                state.customBackgroundColor?.let { putLong(KeyCustomBackgroundColor, it) } ?: remove(KeyCustomBackgroundColor)
                state.customSurfaceColor?.let { putLong(KeyCustomSurfaceColor, it) } ?: remove(KeyCustomSurfaceColor)
                state.customSurfaceVariantColor?.let { putLong(KeyCustomSurfaceVariantColor, it) } ?: remove(KeyCustomSurfaceVariantColor)
                state.customTextColor?.let { putLong(KeyCustomTextColor, it) } ?: remove(KeyCustomTextColor)
                state.customTextSecondaryColor?.let { putLong(KeyCustomTextSecondaryColor, it) } ?: remove(KeyCustomTextSecondaryColor)
                state.customStatusRunningColor?.let { putLong(KeyCustomStatusRunningColor, it) } ?: remove(KeyCustomStatusRunningColor)
                state.customStatusStoppedColor?.let { putLong(KeyCustomStatusStoppedColor, it) } ?: remove(KeyCustomStatusStoppedColor)
                state.customPingFastColor?.let { putLong(KeyCustomPingFastColor, it) } ?: remove(KeyCustomPingFastColor)
                state.customPingMediumColor?.let { putLong(KeyCustomPingMediumColor, it) } ?: remove(KeyCustomPingMediumColor)
                state.customPingSlowColor?.let { putLong(KeyCustomPingSlowColor, it) } ?: remove(KeyCustomPingSlowColor)
                state.customCategoryAppearanceColor?.let { putLong(KeyCustomCategoryAppearanceColor, it) } ?: remove(KeyCustomCategoryAppearanceColor)
                state.customCategoryVpnColor?.let { putLong(KeyCustomCategoryVpnColor, it) } ?: remove(KeyCustomCategoryVpnColor)
                state.customCategoryProxyColor?.let { putLong(KeyCustomCategoryProxyColor, it) } ?: remove(KeyCustomCategoryProxyColor)
                state.customCategorySubscriptionsColor?.let { putLong(KeyCustomCategorySubscriptionsColor, it) } ?: remove(KeyCustomCategorySubscriptionsColor)
                state.customCategoryIntegrationColor?.let { putLong(KeyCustomCategoryIntegrationColor, it) } ?: remove(KeyCustomCategoryIntegrationColor)
                state.customCategoryLogsColor?.let { putLong(KeyCustomCategoryLogsColor, it) } ?: remove(KeyCustomCategoryLogsColor)
                state.customCategoryBackupColor?.let { putLong(KeyCustomCategoryBackupColor, it) } ?: remove(KeyCustomCategoryBackupColor)
                state.customCategoryAboutColor?.let { putLong(KeyCustomCategoryAboutColor, it) } ?: remove(KeyCustomCategoryAboutColor)
                state.customProtocolVlessColor?.let { putLong(KeyCustomProtocolVlessColor, it) } ?: remove(KeyCustomProtocolVlessColor)
                state.customProtocolVmessColor?.let { putLong(KeyCustomProtocolVmessColor, it) } ?: remove(KeyCustomProtocolVmessColor)
                state.customProtocolHysteria2Color?.let { putLong(KeyCustomProtocolHysteria2Color, it) } ?: remove(KeyCustomProtocolHysteria2Color)
                state.customProtocolTrojanColor?.let { putLong(KeyCustomProtocolTrojanColor, it) } ?: remove(KeyCustomProtocolTrojanColor)
                state.customProtocolShadowsocksColor?.let { putLong(KeyCustomProtocolShadowsocksColor, it) } ?: remove(KeyCustomProtocolShadowsocksColor)
                state.customProtocolWireguardColor?.let { putLong(KeyCustomProtocolWireguardColor, it) } ?: remove(KeyCustomProtocolWireguardColor)
                state.customProtocolSocksColor?.let { putLong(KeyCustomProtocolSocksColor, it) } ?: remove(KeyCustomProtocolSocksColor)
                state.customProtocolHttpColor?.let { putLong(KeyCustomProtocolHttpColor, it) } ?: remove(KeyCustomProtocolHttpColor)
                state.customProtocolStrategyColor?.let { putLong(KeyCustomProtocolStrategyColor, it) } ?: remove(KeyCustomProtocolStrategyColor)
                state.customProtocolChainColor?.let { putLong(KeyCustomProtocolChainColor, it) } ?: remove(KeyCustomProtocolChainColor)
                state.customProtocolJsonColor?.let { putLong(KeyCustomProtocolJsonColor, it) } ?: remove(KeyCustomProtocolJsonColor)
            }
